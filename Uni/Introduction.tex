...
In order to check the hypothesis certain system will be build that deals with every stage mentioned above. But first of all limitations for the system need to be set.\\
	...
	\item Every index can be presented as a composition of other indexes (Here meaningful composition with limited number of compositors will be used). We do not speak here about stock indexes that are already a composition of several major stocks (S\&P, DowJones, Nikkei etc.)
