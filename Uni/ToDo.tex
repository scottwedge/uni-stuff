...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item[22.01.2015]: Iterative fine-tuning and learning process 3
		\item[23.01.2015]: Error check
	\end{enumerate}
	\item Week 4: 26.01-30.01.2105 - Second Data processing
	\begin{enumerate}
		\item[26.01.2015]: Texts mining (manual evaluation) 
		\item[27.01.2015]: Texts mining (manual evaluation)
		\item[28.01.2015]: Manual analysis direct(later automatization) and automatic sentiment analysis
		\item[29.01.2015]: Manual analysis direct(later automatization) and automatic sentiment analysis
		\item[20.01.2015]: Results interpretation, Integration 
	\end{enumerate}
