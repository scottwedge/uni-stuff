...
\begin{enumerate}
	...
	\item[Neural networks]
		\begin{enumerate}
			\item \textcolor{black}{\url{http://en.wikipedia.org/wiki/Artificial_neural_network}}
			\item \textcolor{black}{\url{http://www.doc.ic.ac.uk/~nd/surprise_96/journal/vol4/cs11/report.html}}
			\item \textcolor{black}{\url{http://neuralnetworksanddeeplearning.com/chap1.html}}
			\item \textcolor{black}{\url{http://neuralnetworksanddeeplearning.com/}}
			\item \textcolor{black}{\url{http://natureofcode.com/book/chapter-10-neural-networks/}}
			\item \textcolor{black}{\url{http://www.sciencedirect.com/science/journal/08936080}}
			\item \textcolor{black}{\url{http://cs.stanford.edu/people/eroberts/courses/soco/projects/neural-networks/Applications/stocks.html}}
			\item \textcolor{black}{\url{http://en.wikipedia.org/wiki/Stock_market_prediction}}
			\item \textcolor{black}{\url{http://neuroph.sourceforge.net/tutorials/StockMarketPredictionTutorial.html}}
			\item \textcolor{black}{\url{http://neuroph.sourceforge.net/tutorials/StockMarketPredictionTutorial.html}}
			\item \textcolor{black}{\url{http://www.alyuda.com/}}
			\item \textcolor{black}{\url{http://cims.nyu.edu/~ra1221/IIMA/ANN.pdf}}
			\item \textcolor{black}{\url{http://nseindia.com/content/research/FinalPaper206.pdf}}
			\item \textcolor{black}{\url{http://nbviewer.ipython.org/github/jrosen3/cs109annstock/blob/master/Master.ipynb}}
