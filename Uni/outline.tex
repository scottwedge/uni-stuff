...
Unfortunately the linear character of the dependencies is rare in real life. That is why nonlinear regressions took place in statistical analysis. The general form of the nonlinear regression looks as following:
\[Y = f(\beta, x'_{i}) + \epsilon'\]
where f() - nonlinear function, $x'_{i}$ - vector of predictors, $\epsilon$ - vector of parametrs, $\epsilon_{i} \sim N(0, \sigma^2)$.\\
