...
The first and the biggest disadvantage is the performance. This disadvantage appears only for beginners by implementing mid-difficult task with mid-size data structures.\\
...
\subsection{Results}
The end result is currently printed out to a console: the names of the companies in the final regression, main characteristics of the regression (AIC, BIC, Loglikelihood, coefficients and errors, etc.) and the final run time of the program. 
