...
The following graph presents the predictions for the same model but estimated by different program. the model is \mintinline{console}{["Cardinal", "Olympus", "St.Jude", "Lenovo", "MicronTech", "STMElectro"]}. Same color notation is used.\\
