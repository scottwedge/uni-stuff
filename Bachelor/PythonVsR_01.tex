...
3. Give the intro idea that beginner analyst needs to decide what language to start with\\
...
3. Define the formal criteria based on desired set of skills\\
4. Describe general functions of the program to cover the criteria\\
